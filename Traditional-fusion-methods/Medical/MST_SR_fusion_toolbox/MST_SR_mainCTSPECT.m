...
%             [cdata,cmap] = imread(strcat(path,'\Test_near_RGB\',num2str(k),'.png'));
...
%             figure;imshow(uint8(imgf_RGB*255));
            imwrite(uint8(imgf),strcat('C:\Users\HJL\Desktop\Dual-discriminator\medical\CTSPECT\F_I\',num2str(k),'.png'));
            imwrite(uint8(imgf_RGB),strcat('C:\Users\HJL\Desktop\Dual-discriminator\medical\CTSPECT\F\',num2str(k),'.png'));
end
