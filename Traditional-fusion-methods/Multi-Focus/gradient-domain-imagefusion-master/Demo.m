...
%         I(:,:,:,2) = imread(strcat(NameImg,num2str(num),Format));
        I(:,:,:,1) = imread(strcat('C:\Users\HJL\Desktop\far\',num2str(num),'.jpg'));
        I(:,:,:,2) = imread(strcat('C:\Users\HJL\Desktop\near\',num2str(num),'.jpg'));        
...
%     figure,imshow(G),title('Fused image')
     imwrite(G, strcat('C:\Users\HJL\Desktop\result\',num2str(num),'.jpg')); 
end
